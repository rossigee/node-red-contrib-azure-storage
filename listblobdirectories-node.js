module.exports = function (RED) {
    function AzureStorageListBlobDirectoriesNode(config) {
        ...
        node.on('input', function (msg) {
            try {
                ...
                var fetch_page = function() {
                    ...
                    if(prefix) {
                      service.listBlobDirectoriesSegmentedWithPrefix(container, prefix, token, options, _processpage);
                    } else {
                      service.listBlobDirectoriesSegmented(container, token, options, _processpage);
                    }
                };
                fetch_page();
            } catch (err) {
    ...
    RED.nodes.registerType("azure-storage-listblobdirectories", AzureStorageListBlobDirectoriesNode);
};
