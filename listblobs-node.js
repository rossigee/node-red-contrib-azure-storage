module.exports = function (RED) {
    function AzureStorageListBlobsNode(config) {
        ...
        node.on('input', function (msg) {
            try {
                ...
                var fetch_page = function() {
                    ...
                    if(prefix) {
                      service.listBlobsSegmentedWithPrefix(container, prefix, token, options, _processpage);
                    } else {
                      service.listBlobsSegmented(container, token, options, _processpage);
                    }
                };
                fetch_page();
            } catch (err) {
    ...
    RED.nodes.registerType("azure-storage-listblobs", AzureStorageListBlobsNode);
};
